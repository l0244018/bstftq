...
<div id="page-content">
    ...
    <!-- Inbox -->
    <h3 class="page-header page-header-top"><i class="icon-envelope"></i> Inbox <small>With a rich and clean user interface!</small></h3>
        ...
        <div class="inbox-menu">
            <ul class="nav nav-pills nav-stacked">
                <li>
                    ...
                    <a href="#inbox-compose-modal" data-toggle="modal"><i class="icon-pencil"></i> New Message</a>
                </li>
            </ul>
            <ul class="nav nav-pills nav-stacked">
                <li class="active">
                    <a href="javascript:void(0)"><i class="icon-inbox"></i> Inbox <span id="count-inbox" class="inbox-menu-count"></span></a>
                </li>
                <li>
                    <a href="javascript:void(0)"><i class="icon-fighter-jet"></i> Sent</a>
                </li>
                <li>
                    <a href="javascript:void(0)"><i class="icon-star"></i> Starred</a>
                </li>
                <li>
                    <a href="javascript:void(0)"><i class="icon-briefcase"></i> Archive</a>
                </li>
            </ul>
            <ul class="nav nav-pills nav-stacked remove-margin">
                <li>
                    <a href="javascript:void(0)"><i class="icon-circle text-error"></i> Important <span class="inbox-menu-count">18</span></a>
                </li>
                <li>
                    <a href="javascript:void(0)"><i class="icon-circle text-warning"></i> Work <span class="inbox-menu-count">15</span></a>
                </li>
                <li>
                    <a href="javascript:void(0)"><i class="icon-circle text-success"></i> Personal <span class="inbox-menu-count">20</span></a>
                </li>
                <li>
                    <a href="javascript:void(0)"><i class="icon-circle text-info"></i> Vacation <span class="inbox-menu-count">6</span></a>
                </li>
            </ul>
        </div>
        <!-- END Inbox Menu -->
        ...
        <div class="inbox-messages-outer">
            ...
            <div class="inbox-messages">
                ...
                <div class="inbox-messages-list">
                    <input type="text" id="inbox-search" name="inbox-search" class="remove-box-shadow" placeholder="Search..">
                    <ul class="nav nav-pills nav-stacked">
                        <li>
                ...
                <div class="inbox-messages-container">
                    ...
                    <ul class="inbox-messages-content-actions clearfix">
                        <li><a href="javascript:void(0)"><i class="icon-mail-reply"></i> Reply</a></li>
                        <li><a href="javascript:void(0)"><i class="icon-mail-reply-all"></i> Reply to all</a></li>
                        <li><a href="javascript:void(0)"><i class="icon-mail-forward"></i> Forward</a></li>
                        <li><a href="javascript:void(0)"><i class="icon-print"></i> Print</a></li>
                        <li><a href="javascript:void(0)"><i class="icon-briefcase"></i> Archive</a></li>
                        <li><a href="javascript:void(0)"><i class="icon-remove"></i> Delete</a></li>
                    </ul>
                    <!-- END Actions -->

                    <!-- Message Header -->
                    <div class="inbox-messages-content-header">
                        <div class="row-fluid">
                            <div class="span1"><img src="img/placeholders/image_dark_64x64.png" alt="avatar"></div>
                            <div class="span11">
                    ...
                    <div class="inbox-messages-content-reply">
                        <form action="page_inbox.php" class="form-horizontal remove-margin" onsubmit="return false;">
                            <div class="control-group remove-margin">
                                <textarea id="inbox-reply-message" name="inbox-reply-message" class="textarea-large textarea-editor" rows="6"></textarea>
                                <button class="btn btn-success"><i class="icon-edit"></i> Reply</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <!-- New Message Modal -->
    <div id="inbox-compose-modal" class="modal hide">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">×</button>
            <h4><i class="icon-pencil"></i> New Message</h4>
        </div>
            ...
            <form action="page_inbox.php" class="form-horizontal remove-margin" onsubmit="return false;">
                <div class="control-group">
                    <select id="inbox-recipients" name="inbox-recipients" class="select-chosen" data-placeholder="Choose Recipients" multiple>
                        ...
                        <option value="username7">Username7</option>
                        <option value="username8">Username8</option>
                        <option value="username9">Username9</option>
                        <option value="username10">Username10</option>
                    </select>
                </div>
                <div class="control-group remove-margin">
                    <textarea id="inbox-new-message" name="inbox-new-message" class="textarea-large" rows="10">Message..</textarea>
                </div>
            </form>
        </div>
            ...
            if ($(this).hasClass('unread')) {
                ...
                if (num === 1) {
                    countInbox.slideUp(50, function(){
                        $(this).html('<i class="icon-ok"></i>').slideDown(50, function(){
                            $(this).fadeOut(500);
                        });
                    });
                } else {
