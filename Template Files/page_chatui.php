...
<div id="page-content">
    ...
    <!-- ChatUI -->
    <h3 class="page-header page-header-top"><i class="icon-comments"></i> ChatUI <small>Ready to use UI for creating your chat functionality</small></h3>
            ...
            <ul>
                ...
                <li>
                    <a href="javascript:void(0)" class="chat-online" data-toggle="tooltip" data-placement="left" title="Online!">
                        <img src="img/placeholders/image_dark_64x64.png" alt="avatar" class="img-polaroid">
    ...
    <div class="chat-input">
        ...
        <div class="chat-input-inner">
            <form id="form-chat" action="page_chatui.php" class="remove-margin">
                <input type="text" id="chat-message" name="chat-message" class="remove-box-shadow" placeholder="Type a message and hit enter..">
            </form>
        </div>
    </div>
    <!-- END Chat Input -->
