...
<div id="page-content">
    ...
    <!-- Invoice -->
    <!-- Header -->
    <h3 class="sub-header text-center"><i class="icon-file-alt"></i> Invoice #INV00536</h3>
    <div class="row-fluid">
            ...
            <div class="dash-tile dash-tile-dark no-opacity remove-margin">
                ...
                <div class="dash-tile-content">
                    <div class="dash-tile-content-inner-fluid dash-tile-content-light">
                                ...
                                <table class="table table-borderless table-condensed">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="label label-important">#INV00536</span></td>
                                        </tr>
                                        <tr>
                        ...
                        <table class="table table-borderless table-hover">
                            ...
                            <tbody>
                                <tr class="success">
                                    <td>1</td>
                                    <td>Design</td>
                                    <td class="hidden-phone"><em>Corporate Website #1</em></td>
                                    <td class="hidden-phone text-center">$700</td>
                                ...
                                <tr class="success">
                                    <td>2</td>
                                    <td>Design</td>
                                    <td class="hidden-phone"><em>Corporate Website #2</em></td>
                                    <td class="hidden-phone text-center">$700</td>
                                    <td class="hidden-phone text-center">1</td>
                                    <td class="text-center">-</td>
                                    <td class="text-right">$700</td>
                                ...
                                <tr class="success">
                                    <td>3</td>
                                    <td>Design</td>
                                    <td class="hidden-phone"><em>Corporate Website #3</em></td>
                                    <td class="hidden-phone text-center">$700</td>
                                    <td class="hidden-phone text-center">1</td>
                                    <td class="text-center">-</td>
                                    <td class="text-right">$700</td>
                                ...
                                <tr class="warning">
                                    ...
                                    <td class="text-right"><span class="text-error"><strong>$2310</strong></span></td>
                                </tr>
                            </tbody>
                        </table>
                        <!-- END Product Table -->
                        ...
                        <!-- Extras -->
                        <div class="clearfix">
                            <a href="javascript:void(0)" class="btn btn-large btn-success pull-right push">Submit Invoice</a>
                            <a href="javascript:void(0)" class="btn btn-large btn-danger pull-right push">Cancel</a>
