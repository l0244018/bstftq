...
<div id="page-content">
    ...
    <h3 class="page-header page-header-top"><i class="icon-flag"></i> FAQ <small>An example page with questions and answers</small></h3>

    <!-- Faq Tabs -->
    <div class="row-fluid tabs-left">
        <!-- Tab links -->
        <ul id="faq-tabs" class="nav nav-tabs span3" data-toggle="tabs">
            <li class="active"><a href="#faq-tabs-section1"><i class="icon-beer"></i> General</a></li>
            <li><a href="#faq-tabs-section2"><i class="icon-bell"></i> UI</a></li>
            <li><a href="#faq-tabs-section3"><i class="icon-book"></i> Subscriptions</a></li>
            <li><a href="#faq-tabs-section4"><i class="icon-umbrella"></i> Features</a></li>
            <li><a href="#faq-tabs-section5"><i class="icon-wrench"></i> Support</a></li>
            <li><a href="#faq-tabs-section6"><i class="icon-bookmark"></i> Legal Stuff</a></li>
        </ul>
        <!-- END Tab links -->
