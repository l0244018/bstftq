...
<div id="page-content">
            ...
            <div class="dash-tile dash-tile-ocean no-opacity">
                <div class="dash-tile-header">
                    <div class="dash-tile-options">
                        <div class="btn-group">
                            <a href="javascript:void(0)" class="btn dropdown-toggle" data-toggle="dropdown">Select Region <span class="caret"></span></a>
    ...
    <div class="row-fluid hidden-lt-ie9"> <!-- Hide in browsers lower than ie9 -->
        <div class="span6">
...
<!-- Maps for jQVMaps (Don't forget to include them!) -->
